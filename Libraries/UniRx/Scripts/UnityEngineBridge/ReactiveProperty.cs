...
namespace UniRx
{
	...
	public class ReactiveProperty<T> : IReactiveProperty<T>, IDisposable, IOptimizedObservable<T>, IObserverLinkedList<T>
	{
		...
		public static implicit operator T(ReactiveProperty<T> p) => p != null ? p.Value : default;
		public static bool operator ==(ReactiveProperty<T> p, T o)
			=> p != null ? EqualityComparer<T>.Default.Equals(p.Value, o) : Equals(p, o);
		public static bool operator !=(ReactiveProperty<T> p, T o) => !(p == o);
		public override bool Equals(object obj)
			=> obj is T
				? EqualityComparer<T>.Default.Equals(Value, (T)obj)
				: obj == null ? EqualityComparer<T>.Default.Equals(Value, default) : false;
